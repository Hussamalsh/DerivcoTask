...
namespace StudentWebApi4.Common
{
    public class TableManager
    {
        ...
        public TableManager(string _CloudTableName)
        {
            ...
            try
            {
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=studentsa;AccountKey=qiK0Byc0egVZ7CbmUXNdLVKXvHklF4Fm/n60etx3kwOr/xhbba0mxvwUdvuJT/H98odN+C5iB/g2gxUiCKcsKg==;EndpointSuffix=core.windows.net";
